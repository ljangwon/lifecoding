<?php
$dbh = new PDO('mysql:host=leanedu.net;dbname=opentutorials', 'root', '111111');
	...
	<body id="body">
		<div>
			...
			<article>
				...
				<div>
					<a href="update.php?id=<?=$topic['id']?>">수정</a>
					<form method="POST" action="topic_process.php?mode=delete">
